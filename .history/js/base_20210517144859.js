var Main = new Vue({
  ...
  methods: {
    ...
    updateData(options) {
      // 产前准备
      this.qjd = options.cqzb[0].qjd
      this.wlqtl = options.cqzb[0].wlqtl
      this.sbdjs = options.cqzb[0].sbdjs
      ...
      this.ctl = options.cqzb.yc.ctl      // 设备直通率
      this.ydl = options.cqzb.yc.ydl      // 移动率
      this.zjshl = options.cqzb.yc.zjshl  // 治具损坏率
      this.OQC = options.cqzb.yc.OQC      // OQC
